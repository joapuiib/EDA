...
public class Parcial2017CochesPorAnyo {
    public static Map<Integer, Integer> cochesPorAnyo(Map<String, Integer> dgt){
        Map<Integer, Integer> cochesPorAnyo = new TablaHash<>(dgt.talla());
        ...
        for (claves.inicio(); !claves.esFin(); claves.siguiente()){
            ...
            Integer cochesAnyo = cochesPorAnyo.recuperar(anyo);
            if(cochesAnyo == null)
                cochesAnyo = 1;
            else
                cochesAnyo++;
    ...
    public static void main(String[] args) {
        ...
        Map<Integer, Integer> cochesPorAnyo = cochesPorAnyo(dgt);
